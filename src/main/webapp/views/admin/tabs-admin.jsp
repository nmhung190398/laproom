...
<body>
		...
		<div id="page-wrapper">
			...
			<div id="page-inner">
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											<tr>
												...
												<td id="t2-0" class="td-data"><a class="dang-ky-phong"
													shift='0' date='2'>Đăng ký</a></td>
												<td id="t3-0" class="td-data"><a class="dang-ky-phong"
													shift='0' date='3'>Đăng ký</a></td>
												<td id="t4-0" class="td-data"><a class="dang-ky-phong"
													shift='0' date='4'>Đăng ký</a></td>
												<td id="t5-0" class="td-data"><a class="dang-ky-phong"
													shift='0' date='5'>Đăng ký</a></td>
												<td id="t6-0" class="td-data"><a class="dang-ky-phong"
													shift='0' date='6'>Đăng ký</a></td>
												<td id="t7-0" class="td-data"><a class="dang-ky-phong"
													shift='0' date='7'>Đăng ký</a></td>
												<td id="t1-0" class="td-data"><a class="dang-ky-phong"
													shift='0' date='1'>Đăng ký</a></td>
											</tr>
											<tr>
												<td style="width: 50px !important;">Chiều</td>

												<td id="t2-1" class="td-data"><a class="dang-ky-phong"
													shift='1' date='2'">Đăng ký</a></td>
												<td id="t3-1" class="td-data"><a class="dang-ky-phong"
													shift='1' date='3'">Đăng ký</a></td>
												<td id="t4-1" class="td-data"><a class="dang-ky-phong"
													shift='1' date='4'">Đăng ký</a></td>
												<td id="t5-1" class="td-data"><a class="dang-ky-phong"
													shift='1' date='5'">Đăng ký</a></td>
												<td id="t6-1" class="td-data"><a class="dang-ky-phong"
													shift='1' date='6'">Đăng ký</a></td>
												<td id="t7-1" class="td-data"><a class="dang-ky-phong"
													shift='1' date='7'">Đăng ký</a></td>
												<td id="t1-1" class="td-data"><a class="dang-ky-phong"
													shift='1' date='1'">Đăng ký</a></td>

											</tr>
											<tr>
												<td style="width: 50px !important;">Tối</td>

												<td id="t2-2" class="td-data"><a class="dang-ky-phong"
													shift='2' date='2'">Đăng ký</a></td>
												<td id="t3-2" class="td-data"><a class="dang-ky-phong"
													shift='2' date='3'">Đăng ký</a></td>
												<td id="t4-2" class="td-data"><a class="dang-ky-phong"
													shift='2' date='4'">Đăng ký</a></td>
												<td id="t5-2" class="td-data"><a class="dang-ky-phong"
													shift='2' date='5'">Đăng ký</a></td>
												<td id="t6-2" class="td-data"><a class="dang-ky-phong"
													shift='2' date='6'">Đăng ký</a></td>
												<td id="t7-2" class="td-data"><a class="dang-ky-phong"
													shift='2' date='7'">Đăng ký</a></td>
												<td id="t1-2" class="td-data"><a class="dang-ky-phong"
													shift='2' date='1'">Đăng ký</a></td>
											</tr>
										</tbody>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<a id="btn-copy" class="btn btn-primary">Copy Lịch Sang Tuần Tiếp Theo</a>
							<select class="form-control" id="showWeek" style="width: 100px;display: inline;">
					...
					<div class="form-group" style="float: right; margin-top: 10px" >
							<a id="btn-date-now"
								href="tabs/active?idroom=${idRoom }&start=<%=DateUtils.format((Timestamp)request.getAttribute("monday"))%>&end=<%=DateUtils.format((Timestamp)request.getAttribute("sunday"))%>"
			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">
						Đăng ký phòng thực hành : <strong id="title-modal"></strong>
					</h5>
				</div>
				<div class="modal-body">
					<form method="POST" id="form-dang-ky"
						action="<%=request.getContextPath() + "/admin/tabs"%>">
						<input type="hidden" name="type" value="admin">
						<input type="hidden" name="dateStart" id="date-modal"> <input
							type="hidden" name="shift" id="shift-modal"> <input
							type="hidden" value="${idRoom }" name="idRoom"> <input
				...
				<div class="modal-footer">
					...
					<button id="dang-ky" type="button" class="btn btn-primary">Đăng
						ký</button>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		$('#btn-date-now').click(function() {
			...
			day = date.getDate();
			  ...
			  if(!isNaN(date) && !isNaN(month) && !isNaN(year)){
				  var href = location.protocol + '//' + location.host + location.pathname + '?now='+ day + '-' + month + '-' + year + '&idroom=' + '${idRoom}';
		...
		var weekSl = $('#showWeek');
		for(let i = weekOfYearNow; i < 12*4; ++i){
			weekSl.append('<option value='+ i +'> Tuần '+ i +'</option>');
		}
		...
		$('.link-active').attr("style", "float:right;");
	</script>
